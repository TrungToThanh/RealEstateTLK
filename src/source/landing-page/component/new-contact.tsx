...
export const NewContact = () => {
  return (
    <>
      <section className="relative z-10 overflow-hidden bg-white py-10 max-w-[1200px] mx-auto">
        <h2 className="mb-6 text-[30px] font-bold uppercase text-dark">
              ...
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    <h4 className="mb-1 text-xl font-bold ">Địa chỉ</h4>
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    <h4 className="mb-1 text-xl font-bold ">Số điện thoại</h4>
                    <p className="text-base text-body-color dark:text-dark-6">
                      (+84) 9890 22922
                    </p>
                  </div>
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    <h4 className="mb-1 text-xl font-bold ">Địa chỉ email</h4>
                    <p className="text-base text-body-color dark:text-dark-6">
                      manhhien8491@gmail.com
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="relative rounded-lg bg-white p-8 shadow-lg dark:bg-dark-2 sm:p-12">
                <form>
                  ...
                  <ContactTextArea
                    row={6}
                    placeholder="Nội dung bạn nhắn gửi"
                    name="details"
                    defaultValue=""
                  />
                  <div>
      ...
      <Divider />
      <Flex className="justify-between items-center w-full max-w-[1200px] mx-auto pb-10">
        <p> @2024 OscarTo | All rights reserved</p>
        <Space>
